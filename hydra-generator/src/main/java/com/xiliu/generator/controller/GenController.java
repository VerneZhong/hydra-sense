package com.hydra.generator.controller;
...
import com.hydra.generator.service.GenTableService;
...
public class GenController extends BaseController {
    ...
    private void genCode(HttpServletResponse response, byte[] data) throws IOException {
        ...
        response.setHeader("Content-Disposition", "attachment; filename=\"hydra.zip\"");
