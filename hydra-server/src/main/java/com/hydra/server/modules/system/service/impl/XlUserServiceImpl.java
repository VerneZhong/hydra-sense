...
import com.hydra.common.annotation.DataScope;
...
import com.hydra.server.modules.system.entity.XlUserRole;
import com.hydra.server.modules.system.mapper.XlRoleMapper;
import com.hydra.server.modules.system.mapper.XlUserMapper;
import com.hydra.server.modules.system.service.XlUserRoleService;
import com.hydra.server.modules.system.service.XlUserService;
import com.hydra.server.modules.system.vo.RoleUserResultVo;
...
public class XlUserServiceImpl extends ServiceImpl<XlUserMapper, XlUser> implements XlUserService {
    ...
    public XlUser register(XlUser user) {
        ...
        //查询是否有相同用户名的用户
        List<XlUser> xlUsers = this.baseMapper.selectList(new LambdaQueryWrapper<XlUser>().eq(XlUser::getUserCode,newXlUser.getUserCode()));
    ...
    public String checkUserNameUnique(String userCode) {
        //查询是否有相同用户名的用户
        List<XlUser> userList = this.baseMapper.selectList(new LambdaQueryWrapper<XlUser>().eq(XlUser::getUserCode,userCode));
